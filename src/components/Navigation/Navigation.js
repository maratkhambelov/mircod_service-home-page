...
const Navigation = (props) => {
    const {hasNext, hasPrev, toNavigateNext, toNavigateBack} = props;
    ...
    return (
        <div className="constructor_navigation">
            <NavigationItem namePointer="next" {...props}  handleStep={toNavigateNext}  hasSibling={hasNext} icon={iconNext}/>
            <NavigationItem namePointer="prev" {...props} handleStep={toNavigateBack} hasSibling={hasPrev} icon={iconPrev}/>
        </div>
